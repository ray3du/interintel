...
DATABASES = {
    'default': {
        'ENGINE': env('ENGINE') or 'django.db.backends.sqlite3',
        'NAME':  env('POSTGRES_DB') or BASE_DIR / 'db.sqlite3',
        "USER": env("POSTGRES_USER") or "user",
        "PASSWORD": env("POSTGRES_PASSWORD") or "password",
